...
Gem::Specification.new do |gem|
  ...
  gem.authors = ["Jon Vivian"]
  gem.email = ["4leite@gmail.com"]
  gem.homepage = "https://github.com/4leite/administrate-field-nested_has_many"
  ...
  gem.add_dependency "administrate", "~> 0.8.0"
